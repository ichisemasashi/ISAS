...
(deftest p6-screens-and-switcher
  ...
  (testing "P6-2.1-08 切替で未送信入力を消さない（実装は browser の draft 退避）"
    (is (re-find #"未送信|入力欄"
                 (slurp (io/file "docs/詳細設計書_工程6.md"))))))
...
(deftest p6-spec-ids-present
  (let [doc (slurp (io/file "docs/詳細試験仕様書_工程6.md"))
        ids ["P6-2.1-01" "P6-2.1-02" "P6-2.1-03" "P6-2.1-04" "P6-2.1-05" "P6-2.1-06" "P6-2.1-07" "P6-2.1-08"
             ...
             "P6-5-01" "P6-5-02" "P6-5-03" "P6-5-04" "P6-5-05" "P6-5-06"
