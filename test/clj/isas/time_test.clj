...
(deftest now-and-format-test
  (let [fixed (Instant/parse "2026-09-12T00:00:00Z")]
    (binding [time/*now-fn* (fn [] fixed)]
      ...
      (is (= ["2026-09-07T00:00" "2026-09-14T00:00"] (time/tokyo-week-window)))
      (is (= ["2026-08-31T00:00" "2026-09-07T00:00"] (time/tokyo-last-week-window)))
      (is (= ["2026-09-05T00:00" "2026-09-20T00:00"] (time/tokyo-around7-window)))
      (is (= "2026-09-12T09:00" (time/tokyo-now-local-minute)))
