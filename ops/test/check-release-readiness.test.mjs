...
function readyManifest() {
  const gate = () => ({ status: "pass", evidence: "artifact://evidence/123" });
  return {
    schema_version: 1,
    release: {
      version: "1.0.0",
    ...
    gates: {
      ...
      device_encryption: gate(), user_acceptance: gate(),
    },
    quality: {
    ...
    approvals: [
      { actor: "release-commander", role: "RC", approved_at: "2026-08-15T01:00:00Z" },
      { actor: "independent-verifier", role: "Verifier", approved_at: "2026-08-15T01:01:00Z" },
    ],
  };
}
