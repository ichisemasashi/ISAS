...
function evidence() {
  ...
  const release = {
    ...
    gates: Object.fromEntries(["unit_contract", "postgres_rls", "e2e_pwa", "accessibility", "security", "supply_chain", "performance_slo", "device_encryption", "staging_acceptance", "data_migration", "user_acceptance", "operational_acceptance", "business_cutover_acceptance"].map((name) => [name, gate()])),
