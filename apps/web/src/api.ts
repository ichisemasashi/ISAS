...
export interface MvpGateway {
  ...
  getJournalBootstrap(contextId: string, search?: { instructionId?: string; fieldId?: string }, signal?: AbortSignal): Promise<JournalBootstrap>;
