    ...
    <div className="app-shell">
      ...
      <div className="page-shell">
        ...
        <main id="main" tabIndex={-1}>
          ...
          {route === "fields" && <Suspense fallback={<div className="page-content"><p role="status">{tr("app.l220.39")}</p></div>}><FieldsPage api={api} storage={storage} authorization={authorization} online={online} /></Suspense>}
