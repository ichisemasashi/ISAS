...
| 結果 | **High 6／Medium 9／Low 13**（**PG-H1／H4／H5／H6 は対応済**＝ADR-0001 v15/v16・データモデル v9・ADR-0004 v7。**残：PG-H2／H3・Medium 9・Low 13**）。**あわせて「スパイクと文書の差異」15件、「カタログから判定できない検査項目」7件を検出。** **20項目は実測で「正しい」ことも確認**した。 |
